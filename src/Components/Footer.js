                ...
                <div className="main__footer section--padding">
                    <div className="row ">
                            ...
                            <div className="footer__widget--inner">
                                <div className="footer__logo">
                                    <a className="footer__logo--link" href="index.html">
                                        ...
                                        <img className="footer__logo--img" src={"https://risingtheme.com/html/demo-becute/becute/assets/img/logo/nav-log.webp"} alt="" /></a></div>
                        ...
                        <div className="col-lg-2 col-md-4">
                            <div className="footer__widget">
                                ...
                                <ul className="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li className="footer__widget--menu__list"><NavLink to='wishlist'>Wishlist</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='privacy'>Privacy Policy</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='faq'>Frequently</NavLink></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-2 col-md-5">
                            <div className="footer__widget">
                                ...
                                <ul className="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li className="footer__widget--menu__list"><NavLink to='contact'>My Account</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='contact'>Shopping Cart</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='contact'>Login</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='contact'>Register</NavLink></li>
                                    <li className="footer__widget--menu__list"><NavLink to='contact'>Checkout</NavLink></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-7">
                            ...
                            <div className='footer__widget--inner'><p className="footer__widget--desc">Subscribe to our weekly Newsletter and receive updates via email.</p></div>
                            ...
                            <ul className="social__share footer__social d-flex">
                                <li className="social__share--list">
                                    <a className="social__share--icon" rel="nopener" href="https://www.facebook.com">
                                ...
                                <li className="social__share--list">
                                    <a className="social__share--icon" rel="nopener" href="https://twitter.com">
                                ...
                                <li className="social__share--list">
                                    <a className="social__share--icon" rel="nopener" href="https://www.instagram.com">
                                ...
                                <li className="social__share--list">
                                    <a className="social__share--icon"  href="https://www.pinterest.com">
